...
## and create a histogram for Global Active Power for two days in February, 2007.
...
## This script is 1 / 4 completed for Course Project 1 in the Coursera course:
...
## create histogram from global active power data
hist(HH.Power.subset$Global_active_power, 
     ...
     ## specify relative size of label text
     cex.lab=1,
     
     ## specify relative size os axis text
     cex.axis=1,
