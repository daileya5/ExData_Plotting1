...
## This script is 3 / 4 completed for Course Project 1 in the Coursera course:
...
## Now we will subset the original dataset to the two days specified in the assingment:
...
legend("topright", legend = legend.names, col = legend.colors, lwd = 1, cex=1)
